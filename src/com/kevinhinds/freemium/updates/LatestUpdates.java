 ...
 */
package com.kevinhinds.freemium.updates;

import com.kevinhinds.freemium.R;
...
public class LatestUpdates {
	...
	/**
	 * code that will run if it's the first time we've installed the application it will show the
	 * "latest update" notes
	 */
